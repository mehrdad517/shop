    ...
    switch (type) {
      case 'category':
        ...
        if (this.props.setting.categoryExpanded.includes(value)) {
          const index = this.props.setting.categoryExpanded.indexOf(value);
      ...
      case 'blog':
        ...
        if (this.props.setting.blogExpanded.includes(value)) {
          const index = this.props.setting.blogExpanded.indexOf(value);
      ...
      case 'menu':
        ...
        if (this.props.setting.menuExpanded.includes(value)) {
          const index = this.props.setting.menuExpanded.indexOf(value);
        ...
        <li key={key} className="tree-box">
          ...
          >
            <span onClick={() => this.handleExpand(value, 'category')}>
              {hasChild === true &&
                (this.props.setting.categoryExpanded &&
                this.props.setting.categoryExpanded.includes(value) ? (
            ...
            <Link onClick={() => this.props.onClose()} to={`/products/${slug}`}>{label}</Link>
          </span>
          {hasChild === true && (
            <ul
        ...
        <li key={key} className="tree-box">
          ...
          >
            <span onClick={() => this.handleExpand(value, 'blog')}>
              {hasChild === true &&
                (this.props.setting.blogExpanded &&
                this.props.setting.blogExpanded.includes(value) ? (
                  <RemoveCircleOutlineOutlinedIcon
                    color="action"
                    fontSize="small"
                  />
            ...
            <Link onClick={() => this.props.onClose()} to={`/blog/${slug}`}>{label}</Link>
          </span>
          {hasChild === true && (
            <ul
              className="tree-children"
        ...
        <li key={key} className="tree-box">
          ...
          >
            <span onClick={() => this.handleExpand(value, 'menu')}>
              {hasChild === true &&
                (this.props.setting.menuExpanded &&
                this.props.setting.menuExpanded.includes(value) ? (
                  <RemoveCircleOutlineOutlinedIcon
                    color="action"
                    fontSize="small"
                  />
            ...
            {link ? (
              ...
              <Link onClick={() => this.props.onClose()} to={`/page/${slug}`}>{label}</Link>
            )}
          </span>
          {hasChild === true && (
            <ul
      ...
      <div>
        <ul className="menu-container">
          <li>
            <AppsIcon />
            &nbsp;
            <Link onClick={() => this.props.onClose()} to="/">صفحه نخست</Link>
          </li>
          <li>
            <AccountCircleIcon color="primary" />
            &nbsp;
            <Link onClick={() => this.props.onClose()} to="/dashboard">پنل کاربری</Link>
          </li>
          <li>
            <AssignmentIcon color="secondary" />
            &nbsp;
            <Link onClick={() => this.props.onClose()} to="/blog">وبلاگ</Link>
          </li>
        </ul>
        <Divider />
              ...
              <>
                <div className="menu-container">
                  {this.renderCategoryTree(
                    this.props.setting.data.product_categories
                  )}
                </div>
                <Divider />
              </>
