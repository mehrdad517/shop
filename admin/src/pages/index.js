        ...
        return (
            <div>
                <div className="content">
                    <Container>
                        {this.props.auth.permissions.report.sales_report && Boolean(this.props.auth.permissions.report.sales_report.access) && <Box style={{ margin: '30px 0', minHeight: '400px', position: 'relative'}}>
                        ...
                        {this.props.auth.permissions.report.map_reports && Boolean(this.props.auth.permissions.report.map_reports.access) && <Box>
