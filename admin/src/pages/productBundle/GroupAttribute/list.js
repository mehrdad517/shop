            ...
            <div className={'content'}>
                <Container>
                    ...
                    <Box style={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-end'}}>
                        {Boolean(this.props.auth.permissions.group_attribute.store.access) && <AttributeCreate handleRequest={this.handleRequest.bind(this)}  />}
                        {Boolean(this.props.auth.permissions.group_attribute.update.access) &&
                        <Tooltip title="ویرایش">
                            <IconButton onClick={() => this.state.entity ? this.props.history.push('/attributes/' + this.state.entity) : toast.info('یک برند انتخاب کنید')}>
                                <EditIcon/>
                            </IconButton>
                        </Tooltip>
                        }
