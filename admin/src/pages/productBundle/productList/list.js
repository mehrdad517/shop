...
class ProductList extends Component {
    ...
    async handleRequest() {
        ...
        await this.api.getProductLists({
                    ...
                    <Box style={{ margin: '10px 0 20px 0'}}>
                        <Grid container alignItems="center">
                            <Grid item xs={12} sm={6}>
                                <h2>محصولات آیتمی</h2>
                                <p style={{ color: '#8e8e8e'}}>در این صفحه میتوانید محصولات دسته ای ایجاد کنید.</p>
                            </Grid>
                            <Grid item xs={12} sm={6} >
                        ...
                        <div style={{ overflowX: 'auto'}}>
                            <table className='table'>
                                ...
                                <tr>
                                    ...
                                    <th onClick={() => this.handleChangeSort('order')}>اولویت&nbsp;{this.state.sort_field === 'order' ? (this.state.sort_type === 'desc'  ? <ArrowDownwardIcon /> : <ArrowUpwardIcon />) : <SortIcon />}</th>
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td>
                                                {Boolean(this.props.auth.permissions.gallery.update.access) ? <Tooltip title="ویرایش">
                                                    <Link to={`/product-lists/${entity.id}/edit/`}>
                                                        <IconButton>
                                                            <CreateIcon />
                                                        </IconButton>
                                                    </Link>
