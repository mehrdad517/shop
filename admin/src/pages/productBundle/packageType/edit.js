...
class PackageTypeEdit extends Component {
    ...
    componentDidMount() {
        ...
        this.api.fetchPackageType(this.props.entity).then((response) => {
    ...
    handleSubmit (event) {
        ...
        this.api.updatePackageType(this.props.entity, this.state.form).then((response) => {
            if (typeof response != "undefined") {
                if (response.status) {
